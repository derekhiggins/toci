...
# temp patches for overcloud
cd $TOCI_WORKING_DIR/tripleo-image-elements
patch -p1 -N < $TOCI_SOURCE_DIR/patches_overcloud/tripleo-image-elements-0001-testing.patch
